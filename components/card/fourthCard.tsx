...
const FourthCard = React.forwardRef<HTMLDivElement, fourthCardProps>((props, ref) => {
  return (
    <div
      ref={ref} // Attach the ref to the container div
      className='flex flex-col justify-between sticky top-[100px] items-start p-[26.222px] mxs:p-[18.88px] w-[468.056px] mxs:w-[336.9px] h-[302.86px] mxs:h-[218px] rounded-[26.222px] bg-[#fff] shadow-[0px_14px_73.9px_0px_rgba(0,0,0,0.09)]'
