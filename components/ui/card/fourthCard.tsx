...
const FourthCard = React.forwardRef<HTMLDivElement, fourthCardProps>(
  (props, ref) => {
    return (
      <div
        ref={ref}
        className="flex sticky z-20  w-full  h-[700px] mxs:h-[400px] mxxxs:h-[300px]  2xl:h-[900px] 3xl:h-[1100px] mxxs:h-[400px] top-[180px] mxs:top-[220px] mxxxs:top-[320px] justify-center items-center gap-[118.061px] self-stretch"
      >
        <div
